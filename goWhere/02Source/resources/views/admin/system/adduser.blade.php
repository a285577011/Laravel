...
@section('title', isset($info) ? '后台用户详情' : '添加后台用户')
@section('content')
<form id="validation-form" class="form-horizontal" method="post" action="{{isset($info) ? route('admin::editUser', ['id'=>$info->id]) : route('admin::addUser')}}">
    {!! csrf_field() !!}
    <div class="tabbable">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{$info->username or ''}}" name="username" placeholder="用户名" id="form-field-username" class="input-large">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{$info->name or ''}}" name="name" placeholder="姓名" id="form-field-first" class="input-large">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span class="help-inline">
                                <label class="middle">
                                    <input type="checkbox" class="ace roleItem" {{isset($userRoleIds) && in_array($role->id, $userRoleIds) ? 'checked' : ''}} value="{{$role->id}}" name="userRole[]" />
